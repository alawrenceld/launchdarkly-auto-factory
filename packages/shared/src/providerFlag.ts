 ...
 * ("anthropic" | "vega" | "cursor" | …, default "anthropic") so providers can be
 * added without code changes.
 */

import type { LDClient, LDContext } from "@launchdarkly/node-server-sdk";

export type AiProvider = "anthropic" | "vega" | "cursor";

export const PROVIDER_FLAG_KEY = "auto-factory-ai-provider";
const DEFAULT_PROVIDER: AiProvider = "anthropic";

const KNOWN_PROVIDERS: ReadonlySet<string> = new Set<AiProvider>(["anthropic", "vega", "cursor"]);
